...
<div class="container-fluid bg-white  " style="min-height: 60px">
	<div class="row p-2">
		<div class="col-md-3">
			ebook
			<h3 class="text-success float-left">Ebook App</h3>
		</div>
		<div class=" col-md-5">
...
<nav class="navbar navbar-expand-lg navbar-dark  sticky-top"
	...
	<div class="row collapse navbar-collapse" id="navbarSupportedContent">
		<div class=" col-md-7 float-left ">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link" href="#"> <i
						class="fa-solid fa-house fa-2x"></i> Home
				</a></li>
		...
		<div class="col-md-5 float-right">
			<a class=" float-right btn btn-warning mx-1" href="#"><i
				class="fa-solid fa-gear"></i>Setting </a> <a
				class=" float-right btn btn-danger mx-1" href="#">Profile <i
